...
#define	BCM_LINUX_CPU_ENET_IRQ \
	(1+32+BCHP_HIF_CPU_INTR1_INTR_W0_MASK_SET_GENET_0_A_CPU_INTR_SHIFT)

#define BCM_LINUX_UARTA_IRQ \
	(1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_UPG_UART0_CPU_INTR_SHIFT)

#define BCM_LINUX_SPI_IRQ \
	(1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_UPG_SPI_CPU_INTR_SHIFT)
...
#define BCM_LINUX_UARTB_IRQ		(1+BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_UPG_UART1_CPU_INTR_SHIFT)             

#define BCM_LINUX_UARTC_IRQ		(1+BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_UPG_UART2_CPU_INTR_SHIFT) 


#define BCM_LINUX_CPU_ENET_1_IRQ  	(1+32+32+BCHP_HIF_CPU_INTR1_INTR_W2_MASK_SET_MOCA_GENET_0_A_CPU_INTR_SHIFT)
#define BCM_LINUX_CPU_ENET_2_IRQ  	(1+32+32+BCHP_HIF_CPU_INTR1_INTR_W2_MASK_SET_MOCA_GENET_0_B_CPU_INTR_SHIFT)
#define BCM_LINUX_MOCA_IRQ 		(1+32+32+BCHP_HIF_CPU_INTR1_INTR_W2_STATUS_MOCA_INTR_CPU_INTR_SHIFT)
