 ...
 *
 *
 * Date:           Generated on         Mon Jan 14 21:38:46 2008
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/3548/rdb/a0/bchp_usb_ohci.h $
 * 
 * Hydra_Software_Devel/1   1/15/08 5:39p maivu
 ...
 ***************************************************************************/
#define BCHP_USB_OHCI_HcRevision                 0x00780400 /* Host Controller Revision Register */
#define BCHP_USB_OHCI_HcControl                  0x00780404 /* Host Controller Control Register */
#define BCHP_USB_OHCI_HcCommandStatus            0x00780408 /* Host Controller Command Status Register */
#define BCHP_USB_OHCI_HcInterruptStatus          0x0078040c /* Host Controller Interrupt Status Register */
#define BCHP_USB_OHCI_HcInterruptEnable          0x00780410 /* Host Controller Interrupt Enable Register */
#define BCHP_USB_OHCI_HcInterruptDisable         0x00780414 /* Host Controller Interrupt Disable Register */
#define BCHP_USB_OHCI_HcHCCA                     0x00780418 /* Host Controller Communication Area Register */
#define BCHP_USB_OHCI_HcPeriodCurrentED          0x0078041c /* Current Isochronous or Interrupt Endpoint Descriptor Register */
#define BCHP_USB_OHCI_HcControlHeadED            0x00780420 /* First Endpoint Descriptor of the Control List */
#define BCHP_USB_OHCI_HcControlCurrentED         0x00780424 /* Current Endpoint Descriptor of the Control List */
#define BCHP_USB_OHCI_HcBulkHeadED               0x00780428 /* First Endpoint Descriptor of the Bulk List */
#define BCHP_USB_OHCI_HcBulkCurrentED            0x0078042c /* Current Endpoint Descriptor of the Bulk List */
#define BCHP_USB_OHCI_HcDoneHead                 0x00780430 /* Last Completed Transfer Descriptor Added to the Done Queue */
#define BCHP_USB_OHCI_HcFmInterval               0x00780434 /* Frame Bit Time Interval Register */
#define BCHP_USB_OHCI_HcFmRemaining              0x00780438 /* Bit Time Remaining in the Current Frame */
#define BCHP_USB_OHCI_HcFmNumber                 0x0078043c /* Frame Number Register */
#define BCHP_USB_OHCI_HcPeriodicStart            0x00780440 /* Register to Start Processing the Periodic List */
#define BCHP_USB_OHCI_HcLSThreshold              0x00780444 /* LS Packet Threshold Register */
#define BCHP_USB_OHCI_HcRhDescriptorA            0x00780448 /* Root Hub Descriptor A Register */
#define BCHP_USB_OHCI_HcRhDescriptorB            0x0078044c /* Root Hub Descriptor B Register */
#define BCHP_USB_OHCI_HcRhStatus                 0x00780450 /* Root Hub Status Register */
#define BCHP_USB_OHCI_HcRhPortStatus1            0x00780454 /* Root Hub Port Status Register for Port 1 */
#define BCHP_USB_OHCI_HcRhPortStatus2            0x00780458 /* Root Hub Port Status Register for Port 2 */
