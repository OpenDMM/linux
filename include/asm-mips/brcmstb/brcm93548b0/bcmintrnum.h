...
#define	BCM_LINUX_CPU_ENET_IRQ \
	(1+32+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_ENET_EMAC1_CPU_INTR_SHIFT)
...
#define BCM_LINUX_USB_OHCI_0_CPU_INTR \
	(1+32+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_USB_OHCI_CPU_INTR_SHIFT)

#define BCM_LINUX_UARTB_IRQ		(1+BCHP_HIF_CPU_INTR1_INTR_W0_MASK_SET_UPG_UART1_CPU_INTR_SHIFT)             

#define BCM_LINUX_UARTC_IRQ		(1+BCHP_HIF_CPU_INTR1_INTR_W0_MASK_CLEAR_UPG_UART2_CPU_INTR_SHIFT) 

/* these IRQs are virtual (they do not exist in the L1 controller) */
#define BCM_LINUX_SYSTIMER_IRQ		(1+32+32)
