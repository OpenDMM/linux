...
void output_task_defines(void)
{
	...
	offset("TASK_THREAD_INFO", struct task_struct, thread_info);
...
void output_thread_info_defines(void)
{
	...
	constant("_THREAD_SIZE_ORDER", THREAD_SIZE_ORDER);
...
void output_thread_defines(void)
{
	...
	offset("THREAD_MFLAGS", struct task_struct, thread.mflags);
...
void output_sc_defines(void)
{
	...
	offset("SC_STATUS", struct sigcontext, sc_status);
