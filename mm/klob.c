...
#else
#define CONFIG_KLOB_MEM_SIZE		(4096 * 256 * 2)/*   2 MBytes */
#define CONFIG_KLOB_MEM_EXTN		(4096 *  32 * 2)/* 256 KBytes */
#define CONFIG_KLOB_LMT_EXTN		(4096 *  16 * 2)/* 128 KBytes */
#endif
...
#define CONFIG_KLOB_ALIGN	(1 << CONFIG_MIPS_L1_CACHE_SHIFT)
